                                        ...
                                        >
                                            ...
                                            <div className="col-sm-3 d-sm-block d-none p-border text-center">
                                                <div className="h-100 b-left text-center text-sm-white text-dark">
                                                    ...
                                                    {data?.user?.sender_friend_request != null ?
                                                        ...
                                                        <>
                                                            <div
                                                                ...
                                                                <div className='d-flex m-auto col'>
                                                                    <div className='col' onClick={()=>{requestAction(data?.sender_id,'Rejected')}} id={"connection_btn" + index}>
                                                                        Cancel
                                                                    </div>
                                                                    <div className='col' onClick={()=>{requestAction(data?.sender_id,'Accepted')}} id={"connection_btn" + index}>
                                                                        Accepted
                                                                    </div>
                                                                </div>
                                                            </div>
