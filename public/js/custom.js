    ...
    $(".owl-carousel").each(function () {
        var $this = $(this),
            ...
            $(this).owlCarousel({
                ...
                margin:$space,
                nav: $navarrow,
                navText:["<i className='fa fa-angle-left fa-2x'></i>","<i className='fa fa-angle-right fa-2x'></i>"],
                autoplay: $autoplay,
        ...
        if ($progressBar.exists()) {
            $progressBar.each(function (i, elem) {
                ...
                var progressBarRun = function () {
                    ...
                    $elem.delay(delay).append('<span className="progress-type animated fadeIn">' + type + '</span><span className="progress-number animated fadeIn">' + percent + '</span>');
                };
