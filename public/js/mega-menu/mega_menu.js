            ...
            Canvas = {
                ...
                collapse_trigger_button: function () {
                    ...
                    if (settings.mobile_settings.collapse === true) {
                        ...
                        menu_logo_li.append('<div className="menu-mobile-collapse-trigger">' +
                            '<span></span>' +
                            '</div>');
                ...
                mobile_trigger: function () {
                    ...
                    $this.find(dropDown).prev($a).append('<div className="mobileTriggerButton"></div>');
                ...
                click_trigger: function () {
                    ...
                    if (settings.trigger === 'click') {
                        ...
                        $this.find(dropDown).prev($a).append('<div className="desktopTriggerButton"></div>');
